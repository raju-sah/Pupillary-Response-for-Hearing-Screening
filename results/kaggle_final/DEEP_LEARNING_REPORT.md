...
1. **Task 1: Single-Trial Acoustic Salience Discrimination (Dataset B, PsPM-AOB, $N=66$, 18,066 epochs):**
   ...
   * **Comparison against Step 6 Classical ML:**
     * `Multi-Scale 1D-CNN` (ROC-AUC = 0.744, PR-AUC = 0.325) and `Dilated TCN` (ROC-AUC = 0.731, PR-AUC = 0.291) perform on par with top gradient boosted ensembles (`HistGradientBoosting`: ROC-AUC = 0.810, PR-AUC = 0.462; `XGBoost`: ROC-AUC = 0.806, PR-AUC = 0.465), while operating directly on raw 3-channel time-series without explicit feature engineering.
...
![DL vs Classical ROC](file:///kaggle/working/results/figures/dl_vs_classical_roc_task1.png)
...
![DL vs Classical PR](file:///kaggle/working/results/figures/dl_vs_classical_pr_task1.png)
...
![Temporal Attention Weights](file:///kaggle/working/results/figures/temporal_attention_weights.png)
...
![Loss Function Ablation](file:///kaggle/working/results/figures/dl_loss_comparison.png)
...
![Task 2 DL ROC](file:///kaggle/working/results/figures/roc_curves_dl_task2_dataset_a.png)
